...
namespace HelloGame
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (_ballPosition.X < _graphics.GraphicsDevice.Viewport.X || _ballPosition.X > GraphicsDevice.Viewport.Width - 64)
            {
                _ballVelocity.X *= -1;
            }

            if (_ballPosition.Y < _graphics.GraphicsDevice.Viewport.Y || _ballPosition.Y > GraphicsDevice.Viewport.Height - 64)
            {
                _ballVelocity.Y *= -1;
            }
